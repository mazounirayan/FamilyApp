...
class SentMessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    private val dateHeaderText: TextView = itemView.findViewById(R.id.text_gchat_date_me)
    private val messageText: TextView = itemView.findViewById(R.id.text_gchat_message_me)
    private val timestampText: TextView = itemView.findViewById(R.id.text_gchat_timestamp_me)
